...
#include "../../videoDisplay/tcpSocket.h"
...
struct qt_meta_stringdata_tcpTransport_t {
    QByteArrayData data[6];
    char stringdata[43];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_tcpTransport_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_tcpTransport_t qt_meta_stringdata_tcpTransport = {
    {
...
QT_MOC_LITERAL(5, 34, 7)
    ...
    "tcpTransport\0sendData\0\0Mat&\0frame\0"
    "revData\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_tcpTransport[] = {
...
const QMetaObject tcpTransport::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_tcpTransport.data,
      qt_meta_data_tcpTransport,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_tcpTransport.stringdata))
